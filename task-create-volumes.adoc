...
Accédez aux instructions de montage depuis la console NetApp afin de pouvoir monter le volume sur un hôte.

.Étapes
. Dans la console NetApp , ouvrez le système Azure NetApp Files .
